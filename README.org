...
- Download the LineageOS ROM and gapps .zip files from the above link (for gapps
  ...
  - I have also uploaded these onto my gdrive [[https://drive.google.com/file/d/1NpVVayYxHaOYLu2eqB_vZhTzWoNBzq6O/view?usp=sharing][here]] and [[https://drive.google.com/file/d/1wcbb5s40yyglhbU8HkmVg_97_-6act1D/view?usp=sharing][here]], respectively.
...
- Select the "Install" option from main menu and select the gapps suite
- "Reboot" -> "System"
